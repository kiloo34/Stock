...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form id="materialCreate" method="post" action="{{ route('adminPemakaian.store') }}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="jumlah" name="jumlah" class="form-control @error('jumlah') is-invalid @enderror"
                            id="jumlah" placeholder="Jumlah" autocomplete="new-jumlah">
                        @error('jumlah')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var submit = "{{ route('adminPemakaian.store') }}";
        $.ajaxSetup({
            headers: {
